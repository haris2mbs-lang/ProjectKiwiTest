...
fn main() {
    ...
    if env::var_os("CARGO_CFG_WINDOWS").is_some() {
        ...
        res.set("FileDescription", "ProjectKiwi Windows Bootstrapper");
        res.set("ProductName", "ProjectKiwi Bootstrapper");
        res.set("ProductVersion", env!("CARGO_PKG_VERSION"));
        res.set("InternalName", "ProjectKiwi Bootstrapper");
        res.set("OriginalFilename", "ProjectKiwiPlayerLauncher.exe");
        res.set("CompanyName", "ProjectKiwi Corporation");
