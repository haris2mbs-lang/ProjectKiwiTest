                ...
                ExecuteJSON = {
                    ...
                    "Settings": {
                        ...
                        "Arguments": [
                            ...
                            ThumbnailRequestInfo['image_x'],
                            ThumbnailRequestInfo['image_y'],
                            "http://www.ProjectKiwi.eco/asset/?id=1785197",
                            ""
                        ]
                    }
                }
...
def CheckAuthorization():
    ...
    if RCCReturnAuthReq != RCCReturnAuth:
        ...
        if "ProjectKiwi-Gameserver-Communication/1.0" != ReqUserAgent:
            logging.error(f"Unauthorized request from {request.remote_addr} with User-Agent: {ReqUserAgent}")
            return "Unauthorized", 401
        RequestSignature = request.headers.get("X-ProjectKiwi-Request-Signature", default = None) 
...
def Game():
    ...
    #  "creatorType": 1,
    #  "useNewLoadFile": true
    #  "loadfile_location": "https://www.ProjectKiwi.eco/game/gameserver2016.lua"
    # }
    try:
        GameOpenData = request.json
...
def ResetAccessKeyAndRestart():
    try:
        ...
        try:
            ...
            os.system("taskkill /IM ProjectKiwiPlayerBeta.exe /T /F")
        except:
            pass
...
def CollectDeadProcess():
    try:
        ...
        for process in processes:
            if "RCCService" in process.name() or "ProjectKiwiPlayerBeta" in process.name():
        ...
        for active_server in running_servers:
            ...
            if "ProjectKiwiPlayerBeta" in active_server.name():
