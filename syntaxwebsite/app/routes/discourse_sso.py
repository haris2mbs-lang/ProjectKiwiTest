...
def DiscourseSSOIndex():
    return render_template("discourse/leaving-ProjectKiwi.html", baseurl=config.DISCOURSE_FORUM_BASEURL)
...
def DiscourseSSO():
    ...
    if request.method == "GET":
        ...
        payload = {
            "nonce": nonce,
            "email": f"ProjectKiwiUser{AuthenticatedUser.id}@forum.ProjectKiwi.eco",
