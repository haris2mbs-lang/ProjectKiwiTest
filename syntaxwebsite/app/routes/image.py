...
def multi_avatar_headshot():
    ...
    for userId in userIds:
        ...
        ProcessedRequests.append({
            "targetId": userId,
            "state": "Completed",
            #"imageUrl": f"{config.CDN_URL}/{CroppedHash}", # 2020 Does not allow things like cdn.ProjectKiwi.eco to be used directly in the "Texture" property so we have to redirect them to an allowed route on the www. domain
