...
def characterFetch():
    ...
    if user is None:
        return 'https://www.ProjectKiwi.eco/Asset/BodyColors.ashx?userId=5973;https://www.ProjectKiwi.eco/Asset/?id=23882;https://www.ProjectKiwi.eco/Asset/?id=28253;',200
...
def LegacyAssetSupport():
    ...
    if AssetObj.asset_type in [AssetType.Shirt, AssetType.TShirt, AssetType.Pants]: # Fix a mistake I made awhile ago with Shirts, TShirts and Pants where the asset content URL was https://ProjectKiwi.eco/asset/?id= instead of http://www.ProjectKiwi.eco/asset/?id=
        AssetVersonContent = AssetVersonContent.replace("https://ProjectKiwi.eco/asset/?id=".encode("utf-8"), "http://www.ProjectKiwi.eco/asset/?id=".encode("utf-8"))
