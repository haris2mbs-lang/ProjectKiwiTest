...
def refund_unused_invite_keys():
    ...
    This is an automated message to inform you that as invite keys are no longer used on ProjectKiwi, we have refunded you R$ {AmountOwed} for {InviteKeysDeleted} unused invite keys. Please contact us on our Discord Server if you have any questions.
...
Sincerely,
The ProjectKiwi Team""", userid = RecievingUserObj.id )
...
Sincerely,
The ProjectKiwi Team""", userid = SendingUserObj.id )
