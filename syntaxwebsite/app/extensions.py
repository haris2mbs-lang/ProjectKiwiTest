...
if USE_LOCAL_CONFIG:
    ...
    Config = ConfigClass()
    # Create a mock limiter storage for local dev
    class MockLimiterStorage:
        def __init__(self):
            self.data = {}
        def incr(self, key, times=1):
    ...
    mock_storage = MockLimiterStorage()
else:
            ...
            requests.post(
                ...
                json = {
                    ...
                    "embeds": [{
                        ...
                        "footer": {
                            "text": f"ProjectKiwi Item Release Bot"
                        },
...
This is an automated message to inform you that your Builders Club membership has expired, if you wish to renew your membership you can do so by following the instructions below
 ...
 - For Outrageous Builders Club members:
    - You can renew your membership by donating $5 to our Ko-Fi page https://ko-fi.com/ProjectKiwieco

If you have any questions or concerns, please contact our support in our Discord Server

Sincerely,
The ProjectKiwi Team""",
