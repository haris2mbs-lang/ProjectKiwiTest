...
def FormatBackendUrl(Endpoint: str) -> str:
    """
    Formats the given endpoint into a full URL to the ProjectKiwi backend server.
    """
...
async def BuildUserEmbed( UserObject: dict ) -> discord.Embed:
    ...
    UserEmbed.url = f"https://www.ProjectKiwi.eco/users/{UserObject['id']}/profile"
    UserEmbed.set_thumbnail(url=f"https://www.ProjectKiwi.eco/Thumbs/Head.ashx?x=100&y=100&userId={UserObject['id']}")
...
async def BuildItemEmbed( ItemObject: dict ) -> discord.Embed:
    ...
    ItemEmbed.url = f"https://www.ProjectKiwi.eco/catalog/{ItemObject['id']}/"
    ItemEmbed.set_thumbnail(url=f"https://www.ProjectKiwi.eco/Thumbs/Asset.ashx?x=180&y=180&assetId={ItemObject['id']}")
    ...
    if ItemObject["creator"] != None:
        ItemEmbed.add_field(name="Creator", value=f"[{ItemObject['creator']['username']}](https://www.ProjectKiwi.eco/users/{ItemObject['creator']['id']}/profile)")
    else:
...
@DiscordClient.tree.command(name="ping", description="Pings the ProjectKiwi website, and returns the response time.")
async def ping( interaction: discord.Interaction ):
    """
    Pings the ProjectKiwi backend server, and returns the response time.
    """
    ...
    try:
        ...
        await interaction.response.send_message(embed = discord.Embed(
            title="Error! :(",
            description=f"An error occured while trying to ping the ProjectKiwi website maybe it's down?",
    ...
    await interaction.response.send_message(embed = discord.Embed(
         title="Pong!",
         description=f"ProjectKiwi website responded in `{round(time.time() - StartTime, 3)}s`",
         color=discord.Color.green()
    ))

@DiscordClient.tree.command(name="lookup-username", description="Searches ProjectKiwi for a user with the given username.")
@app_commands.describe(username="Searches ProjectKiwi for a user with the given username.")
async def lookup_username( interaction: discord.Interaction, username: str ):
    """
    Requests info from the ProjectKiwi website about a user with the given username.
    """
    RequestSession = await GetRequestSession()
    try:
        ...
        await interaction.response.send_message(embed = discord.Embed(
            title="Error! :(",
            description=f"An error occured while trying to lookup the username `{username}` maybe the ProjectKiwi website is down?",
            color=discord.Color.red()
        ))
        return
...
@DiscordClient.tree.command(name="lookup-userid", description="Searches ProjectKiwi for a user with the given userId.")
@app_commands.describe(userid="Searches ProjectKiwi for a user with the given userId.")
async def lookup_userid( interaction: discord.Interaction, userid: int ):
    """
    Requests info from the ProjectKiwi website about a user with the given userId.
    """
    RequestSession = await GetRequestSession()
    try:
        ...
        await interaction.response.send_message(embed = discord.Embed(
            title="Error! :(",
            description=f"An error occured while trying to lookup the userId `{userid}` maybe the ProjectKiwi website is down?",
            color=discord.Color.red()
        ))
        return
...
@DiscordClient.tree.command(name="lookup-user", description="Searches ProjectKiwi for a user with the given member.")
@app_commands.describe(member="Searches ProjectKiwi for a user with the given member.")
async def lookup_user( interaction: discord.Interaction, member: discord.Member ):
    """
    Requests info from the ProjectKiwi website about a user with the given member.
    """
    RequestSession = await GetRequestSession()
    try:
        ...
        await interaction.response.send_message(embed = discord.Embed(
            title="Error! :(",
            description=f"An error occured while trying to lookup the account for <@{member.id}> maybe the ProjectKiwi website is down?",
            color=discord.Color.red()
        ))
        return
...
@DiscordClient.tree.command(name="lookup-item", description="Searches ProjectKiwi for an item with the given itemid.")
@app_commands.describe(itemid="Searches ProjectKiwi for an item with the given itemid.")
async def lookup_item( interaction: discord.Interaction, itemid: int ):
    ...
    try:
        ...
        await interaction.response.send_message(embed = discord.Embed(
            title="Error! :(",
            description=f"An error occured while trying to lookup for Item `{itemid}` maybe the ProjectKiwi website is down?",
            color=discord.Color.red()
        ))
        return
...
@DiscordClient.tree.command(name="claim-roles", description="Claims your roles from the ProjectKiwi website.")
async def claim_roles( interaction: discord.Interaction ):
    ...
    try:
        ...
        await interaction.response.send_message(embed = discord.Embed(
            title="Error! :(",
            description=f"An error occured while trying to retrieve info about you, maybe the ProjectKiwi website is down?",
            color=discord.Color.red()
        ))
        return
...
@DiscordClient.tree.command(name="claim-turbo", description="Claim your Turbo Builders Club after boosting the server. ( Must have a linked ProjectKiwi Account )")
async def claim_turbo( interaction: discord.Interaction ):
    ...
    try:
        ...
        await interaction.response.send_message(embed = discord.Embed(
            title="Error! :(",
            description=f"An error occured while trying to contact the ProjectKiwi website, maybe ProjectKiwi is down?",
            color=discord.Color.red()
        ))
        return
